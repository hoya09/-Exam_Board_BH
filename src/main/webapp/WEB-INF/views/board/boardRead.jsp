...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
	...
	<%-- <br>
	<h1>댓글</h1>
	<input type="hidden" name="r_boardNum" value="${dto.b_no}" id="r_boardNum">	
	<!-- sessionScope.m_id  <- 로그인한 아이디 -->
	아이디 : <input type="text" name="r_writer" id="r_writer" value="${sessionScope.m_id}" readonly="readonly">
	내용 : <input type="text" name="r_content" id="r_content">
	<input type="button" id="replyRegistBtn" value="댓글등록"><br><br>
